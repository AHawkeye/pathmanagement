...
public class Stage1 {
    ...
    public static String getInitialCheckedCities(){
        return "{\"city0\":[\"询问病史及体格检查\",\"完成病历书写\",\"对症支持治疗\",\"患者家属签署各种必要的知情同意书\"],\"city1\":[\"血液病护理常规\",\"二级护理\"],\"city2\":[\"血常规及分类、尿常规、大便常规＋隐血\",\"乙肝二对半\",\"常规检查\"],\"city3\":[\"介绍病房环境、设施和设备\",\"入院护理评估\"]}";
    }
    public static String getInitialDetailCities(){
        return "{\"city0\":{},\"city1\":{\"input1\":\"\",\"input0\":\"\"},\"city2\":{\"input4\":[\"FISH 检测\",\"基因突变\"],\"input3\":\"\",\"input2\":[],\"input1\":[],\"input0\":[]},\"city3\":{}}";
    }
}
