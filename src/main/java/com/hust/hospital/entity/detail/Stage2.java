...
public class Stage2 {
    ...
    public static String getInitialCheckedCities() {
        return "{\"city0\":[\"完成入院检查\"],\"city1\":[\"其他医嘱\"],\"city2\":[\"其他医嘱\",\"外周血免疫表型\",\"分子生物学检测TP53基因突变及IGHV突变状态\",\"外周血细胞(CpG刺激)/分子遗传学\",\"骨髓形态学、病理、免疫组化（必要时）\"],\"city3\":[]}";
    }
    public static String getInitialDetailCities() {
        return "{\"city0\":{},\"city1\":{\"input0\":\"ffdsbvc\"},\"city2\":{\"input0\":\"dsfvzc\"},\"city3\":{}}";
    }
}
